...
export type Product={id:string;sellerId:string;brandId:string;title:I18nText;description:I18nText;category:string;color:"yellow"|"white"|"rose"|"mixed";purity:585|750|916|999;weightGrams:number;priceAMD:number;compareAtAMD?:number;sku?:string;stock:number;size?:string;condition:"new"|"preowned";gemstone?:string;stoneCt?:number;images:string[];status:"draft"|"active"|"sold"|"archived";featured?:boolean;createdAt?:any};
